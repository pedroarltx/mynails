  ...
  return (
    <Dialog.Root open={isOpen} onOpenChange={onClose} >
      <Dialog.Portal>
        ...
        {/* Conteúdo do Modal */}
        <Dialog.Content className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white p-4 sm:p-6 rounded-lg shadow-lg w-full  lg:max-w-[50vw] sm:max-w-[95vw] max-h-[70vh] overflow-y-auto">
          {/* Título do Modal */}
